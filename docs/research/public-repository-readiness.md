...
| README lacked practical public-source guidance                           | Resolved with a concise overview, synthetic native screenshot, source install and update steps, optional MCP setup, data and recovery boundaries, verification, research links, and the MIT notice. | `67ce284`                               |
