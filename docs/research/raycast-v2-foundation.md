...
3. **Quick Add metadata requires a Form.** A command accepts at most three root-search arguments, and their types are only text, password, and a manifest-defined dropdown. The requested required title, dynamic project selection, date picker, and optional notes do not fit that surface. A compact Form supports those controls without static project data or text-encoded dates. [current extension schema](https://www.raycast.com/schemas/extension.json), [arguments lifecycle](https://developers.raycast.com/information/lifecycle/arguments.md), [Form](https://developers.raycast.com/api-reference/user-interface/form.md)
...
| Quick Add         | [schema](https://www.raycast.com/schemas/extension.json), [arguments](https://developers.raycast.com/information/lifecycle/arguments.md), [Form](https://developers.raycast.com/api-reference/user-interface/form.md) | Confirmed                        | Use a compact Form for title, dynamic project selection, a date picker, and notes.                                    |
...
- title is required;
- project is a dynamic dropdown that defaults to Inbox;
- due date uses an optional date picker;
...
4. **Quick Add uses a compact Form.** It collects a required title plus optional project, due date, and notes. The platform’s three-argument cap and static dropdown data should be treated as product constraints, not worked around with brittle encoding.
...
The root-argument prototype confirmed the visible optional markers, three-argument limit, static dropdown data, and lack of a date picker. Quick Add now uses a compact Form with a required title, dynamic project dropdown, optional date picker, and optional notes. This resolves the argument contract without importing Todoist NLP. [arguments](https://developers.raycast.com/information/lifecycle/arguments.md), [Form](https://developers.raycast.com/api-reference/user-interface/form.md)
